<div align="center">
  ...
  <a href="https://github.com/Singhkunall">
    <img src="https://github-profile-trophy.vercel.app/?username=Singhkunall&theme=tokyonight&no-frame=true&no-bg=true&margin-w=10&column=6" alt="Trophies" />
  </a>
...
| :--- | :--- | :--- | :---: |
| 🤖 [**ai-investment-agent**](https://github.com/Singhkunall/ai-investment-agent) | Autonomous AI Agent for financial intelligence & investment analytics | `JavaScript` `AI` `Node` | 🚀 Active |
| 🔒 [**pii-doc-redactor**](https://github.com/Singhkunall/pii-doc-redactor) | Automated PII redaction engine for secure document processing | `Python` `Data Science` | 🛡️ Live |
| 💖 [**love-verse-backend**](https://github.com/Singhkunall/love-verse-backend) | High-performance scalable backend REST API for Love-Verse | `Node.js` `Express` `JS` | ⚡ Active |
| 📊 [**Car-Price---Prediction**](https://github.com/Singhkunall/Car-Price---Prediction) | Machine learning predictive analytics model for vehicle pricing | `Jupyter` `Python` `ML` | 🎯 Complete |
